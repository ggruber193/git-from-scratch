...
def main():
    ...
    cat_file_view_options.add_argument('-p', help="pretty-print object's content", action="store_const", dest="cat_print_option", const="p")
    cat_file_view_options.add_argument('-t', help="pretty-print object's type", action="store_const", dest="cat_print_option", const="t")
    cat_file_view_options.add_argument('-s', help="pretty-print object's size", action="store_const", dest="cat_print_option", const="s")
